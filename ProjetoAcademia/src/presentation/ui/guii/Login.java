...
public class Login extends javax.swing.JFrame {
    ...
    String username = txtAdicionarRegistro.getText();
    ...
    try (java.sql.Connection conn = conexao.Conexao.getConexao()) {
        ...
        if (rs.next()) {
            ...
            boolean primeiroLogin = rs.getBoolean("primeiro_login");
            String tipo = rs.getString("tipo_utilizador");

            javax.swing.JOptionPane.showMessageDialog(this, "Login com sucesso!");

            //VERIFICAR PRIMEIRO LOGIN
            if (primeiroLogin) {
                new AlterarSenha().setVisible(true);
            } else {
                //depois crias dashboards diferentes
